...
<small>Image was generated by ImageGen on 12th Feb 2025</small>
...
In the following instructions, ```<algo>``` (or ```"algo"```) can be replaced with one of the following algorithms:
- "coma"
- "qmix"
- "maa2c"
- "mappo"
